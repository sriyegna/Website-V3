                    ...
                    <Card shadow={0} style={{width: '80%', margin: '0 auto'}}>
                        <Grid className="about-grid">
                            <Cell col={4} className="about-cell">    
                                <table id="wrapper">
                                    <tr>
                                        <td><img src={Ninja} style={{width: '100%', height: 'auto', margin: '0 auto'}} className="about-avatar" /></td>
                                    </tr>
                                </table>
                            </Cell>
                            <Cell col={8} className="about-cell">
                                ...
                                <p>I am primarily focused on developing <span className="background-grey">web applications</span> however I also enjoy developing in other languages such as <span className="background-grey">C, C#, and Java</span>. I am currently working at BlackBerry creating a web application using React to help monitor cybersecurity threats using Cylance - artificial based advanced threat detection!</p>

                                <div className="chart">
                                    <Grid className="about-grid">
                                        <Cell style={{margin: '0 auto'}} col={3}>
                                            Web Development<br/>
                                            <DonutChart
                                            width={100}
                                            height={100}
